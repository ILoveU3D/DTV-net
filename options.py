...
shenzhenAngleNum = y["shenzhenAngleNum"]
shenzhenDetectorSize = y["shenzhenDetectorSize"]
shenzhenVolumeSize = y["shenzhenVolumeSize"]
shenzhenParameterRoot = y["shenzhenParameterRoot"]